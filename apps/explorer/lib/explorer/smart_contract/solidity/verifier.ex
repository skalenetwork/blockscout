...
defmodule Explorer.SmartContract.Solidity.Verifier do
  ...
  defp compare_bytecodes(
    ...
    smart_contract_creation_transaction = Chain.smart_contract_creation_transaction_bytecode(address_hash)

    bc_deployed_bytecode = Chain.smart_contract_bytecode(address_hash)

    bc_creation_transaction_input =
      case smart_contract_creation_transaction do
    ...
    cond do
      smart_contract_creation_transaction == nil ->
         {:ok, %{abi: abi}}
